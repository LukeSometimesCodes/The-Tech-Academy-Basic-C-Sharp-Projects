...
namespace DailyReport
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            bool needHelp1 = bool.Parse(needHelp);
            int pageNum1 = Int32.Parse(pageNum);
            string hoursStudied1 = Console.ReadLine();
            int hoursStudied = Convert.ToInt32(hoursStudied1);
            Console.WriteLine("Excellent work getting " + hoursStudied1 + " hours in! Thanks for everything, a instructor will contact you if needed.");
